...
import com.palomino.confecontrol.model.other.CookieUtil;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (StringUtils.hasText(token) && jwtTokenProvider.validarToken(token)) {
                ...
                if (userRoles.contains("Colaborador") || userRoles.contains("Supervisor") || userRoles.contains("Administrador")) {
